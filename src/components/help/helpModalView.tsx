      ...
      <Tabs variant="outline" defaultValue="info" orientation="vertical">
        ...
        <Tabs.Panel value="info" ml={10}>
          <Text>
            ...
            friends but never manage to figure out exactly which games they want to play. GameSquad
            allows you and your friends to add a roster of the game you are interested in and vote
            on the ones you are interested in playing, so that you can more easily come to a
        ...
        <Tabs.Panel value="squadCreate" ml={10}>
          <Text>
            ...
            a new squad, which you can then find in the sidebar to the left. The squad can be
            removed by pressing the 3 dots in the upper right corner of the screen and choosing
            &apos;Delete squad&apos;.
          </Text>
        </Tabs.Panel>
        <Tabs.Panel value="squadJoin" ml={10}>
          <Text>
            ...
            the squad screen. You can leave the squad by pressing the 3 dots in the upper right
            corner of the screen and choosing &apos;Leave squad&apos;.
          </Text>
        </Tabs.Panel>
        <Tabs.Panel value="gameAdd" ml={10}>
          <Text>
            ...
            squad. The game can be removed by pressing the cross at the top right of the game&apos;s
            card.
          </Text>
        </Tabs.Panel>
        <Tabs.Panel value="gameVote" ml={10}>
          <Text>
            ...
            each game card. This vote will be counted along with the other squad members to show
            what all of you think about the games
          </Text>
        </Tabs.Panel>
      </Tabs>
    </Group>
